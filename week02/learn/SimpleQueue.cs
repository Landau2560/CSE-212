public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Dequeue was removing the value at index 1 instead of index 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue was inserting at the front of the queue instead of the back
