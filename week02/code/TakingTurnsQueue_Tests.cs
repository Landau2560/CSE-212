...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Players with remaining turns were not re-enqueued correctly when a new player was added.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: A person with Turns = 0 was treated as having no turns remaining and was not re-enqueued even though 0 should represent infinate turns.
    ...
    // Defect(s) Found: A person was negative Turns was treated as having no turns remaining and was not re-enqueued, even though negative values should represent infinate turns.
